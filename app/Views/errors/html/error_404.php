...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="/template/assets/vendor/css/pages/page-misc.css" />
...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <a href="/back" class="btn btn-primary">Back to home</a>
            <div class="mt-3">
                <img src="/template/assets/img/illustrations/page-misc-error-light.png" alt="page-misc-error-light" width="500" class="img-fluid" data-app-dark-img="illustrations/page-misc-error-dark.png" data-app-light-img="illustrations/page-misc-error-light.png" />
            </div>
        </div>
    </div>
    <!-- /Error -->
